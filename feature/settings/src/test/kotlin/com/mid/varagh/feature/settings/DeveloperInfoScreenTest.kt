...
class DeveloperInfoScreenTest {
    ...
    private val developerInfoLabel =
        ApplicationProvider.getApplicationContext<Context>().getString(R.string.settings_developer_info)
    ...
    fun showsBackendFlagAndBaseUrl() {
        ...
        composeRule.onNodeWithTag("flag_value", useUnmergedTree = true).assertTextEquals("false")
